    ...
    <div className="min-h-screen flex flex-col bg-white text-[#4a5568]">
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 space-y-20">
        ...
        <section className="space-y-6">
          ...
          <blockquote className="p-6 rounded-2xl bg-[#f8f9fa] border-l-4 border-[#2b9aaa] shadow-sm text-base sm:text-lg italic text-[#0f1117] leading-relaxed">
        ...
        <section className="space-y-6 border-t border-black/10 pt-12">
          <div className="flex items-center gap-3">
            <span className="font-mono text-sm text-[#2b9aaa] font-bold">01</span>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#0f1117]">Why We Exist</h2>
          </div>
        ...
        <section className="space-y-6 border-t border-black/10 pt-12">
          <div className="flex items-center gap-3">
            <span className="font-mono text-sm text-[#2b9aaa] font-bold">02</span>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#0f1117]">What We&rsquo;re Building</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            <div className="p-5 rounded-2xl bg-white border border-black/10 shadow-sm space-y-2">
              <h3 className="text-base font-bold text-[#0f1117]">Enterprise Workflow Automation</h3>
            ...
            <div className="p-5 rounded-2xl bg-white border border-black/10 shadow-sm space-y-2">
              <h3 className="text-base font-bold text-[#0f1117]">NexAgent HMS (Healthcare Suite)</h3>
              <p className="text-xs text-[#718096] leading-relaxed">
        ...
        <section className="space-y-8 border-t border-black/10 pt-12">
          <div className="flex items-center gap-3">
            <span className="font-mono text-sm text-[#2b9aaa] font-bold">03</span>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#0f1117]">How We Think</h2>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="font-mono text-xs font-bold text-[#2b9aaa]">{pillar.num}</span>
                    <div className="p-2 rounded-lg bg-[#2b9aaa]/10 text-[#2b9aaa]">
                      <PillarIcon className="w-4 h-4" />
                    </div>
                  </div>
                  <h3 className="text-lg font-bold text-[#0f1117]">{pillar.title}</h3>
                  <p className="text-sm text-[#4a5568] leading-relaxed">{pillar.desc}</p>
                </div>
              );
            })}
          </div>
        ...
        {/* 04 — The Founders */}
        <section id="founders" className="space-y-8 border-t border-black/10 pt-12">
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              <span className="font-mono text-sm text-[#2b9aaa] font-bold">04</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            {/* Manthan Kachhadiya */}
            <div className="bg-white rounded-2xl border border-black/10 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
              <div>
              ...
              <div className="px-6 sm:px-8 pb-6 pt-3 border-t border-black/[0.06] flex items-center gap-2 text-xs font-mono text-[#718096]">
                <Code2 className="w-4 h-4 text-[#2b9aaa]" />
                <span className="font-medium text-[#4a5568]">Domain: Technology &amp; AI</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-black/10 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
              ...
              <div className="px-6 sm:px-8 pb-6 pt-3 border-t border-black/[0.06] flex items-center gap-2 text-xs font-mono text-[#718096]">
                ...
                <span className="font-medium text-[#4a5568]">Domain: Product &amp; Business</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-6 border-t border-black/10 pt-12">
          <div className="flex items-center gap-3">
            <span className="font-mono text-sm text-[#2b9aaa] font-bold">05</span>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#0f1117]">Where We&rsquo;re Going</h2>
          </div>
          ...
          <div className="p-8 rounded-2xl bg-white border border-black/10 shadow-sm space-y-4">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4 text-xs font-mono text-[#4a5568]">
              <span className="px-3 py-1.5 rounded-lg bg-[#f8f9fa] border border-black/[0.08] flex items-center gap-1.5">
                <Globe2 className="w-3.5 h-3.5 text-[#2b9aaa]" />
                <span>Global Cloud Architecture</span>
              </span>
              <span className="px-3 py-1.5 rounded-lg bg-[#f8f9fa] border border-black/[0.08] flex items-center gap-1.5">
                <Building2 className="w-3.5 h-3.5 text-[#2b9aaa]" />
                <span>Operating from India for Global Enterprises</span>
              </span>
              <span className="px-3 py-1.5 rounded-lg bg-[#f8f9fa] border border-black/[0.08]">
                ✦ Founded: 2026
              </span>
            </div>
          </div>
        ...
        {/* 06 — Work With Us */}
        <section className="p-8 sm:p-12 rounded-2xl bg-[#0f1117] text-white text-center space-y-5">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.06] border border-white/[0.12] text-[#2b9aaa] text-xs font-mono font-bold uppercase tracking-wider">
          ...
          <div className="pt-2">
            <button
              ...
              className="px-8 py-4 text-xs sm:text-sm font-bold uppercase tracking-wider text-[#0f1117] bg-white hover:bg-[#f1f5f9] active:scale-[0.98] rounded-xl shadow-lg transition-all"
            >
